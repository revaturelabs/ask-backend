...
public class UserModelTest {
  ...
  public void userJavaBeanTest() {
    ...
    // .toString()
    String userString =
        "User [id=" + testUser.getId() + ", username=" + testUser.getUsername() + ", password="
            + testUser.getPassword() + ", isExpert=" + testUser.isExpert() + ", expertTags="
            + testUser.getExpertTags() + ", questions=" + testUser.getQuestions().toString()
            + ", responses=" + testUser.getResponses().toString() + "]";
