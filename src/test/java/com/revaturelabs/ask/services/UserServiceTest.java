...
public class UserServiceTest {
  ...
  public void usersFindAllTest() {
    when(userRepositoryMock.findAll(PageRequest.of(0, 5)))
        .thenReturn(ServiceMockData.returnUsersPage);
  ...
  public void userCreationAccuracyTest() {
    when(userRepositoryMock.save(ServiceMockData.testUser1))
        .thenReturn(ServiceMockData.testUser1PostCreate);

    assertEquals(ServiceMockData.testUser1PostCreate,
        userServiceImpl.create(ServiceMockData.testUser1));
  }
  ...
  public void userUpdateTagsTest() {
    ...
    assertEquals(ServiceMockData.testUser2.getExpertTags(),
        ServiceMockData.testUser1.getExpertTags());
  }
