...
// assertEquals(ResponseEntity.ok(page.getContent()), questionControllerImpl.getAllQuestions(0,
// 20));
// assertEquals(ResponseEntity.ok(page.getContent()), questionControllerImpl.getAllQuestions(null,
// null));
// }
//
// @Test
...
//
// when(questionServiceMock.highlightResponse(1,
// 1)).thenThrow(DataIntegrityViolationException.class);
// assertEquals(ResponseEntity.ok(questionControllerImpl.highlightResponse(1, 1).getBody()),
// questionControllerImpl.highlightResponse(1, 1));
// }
//
...
// tags.add("Tag 2");
//
// when(questionServiceMock.findAllByTagNames(true, null, 0,
// 20)).thenThrow(TagNotFoundException.class);
//
...
// Question question = new Question();
// try {
// when(questionServiceMock.addImageToQuestion(1,
// mockRequest)).thenThrow(ImageConflictException.class);
// } catch (QuestionNotFoundException | ImageConflictException | IOException e) {
// // TODO Auto-generated catch block
// e.printStackTrace();
// }
...
// try {
// when(questionServiceMock.addImageToQuestion(1,
// mockRequest)).thenThrow(QuestionNotFoundException.class);
// } catch (QuestionNotFoundException | ImageConflictException | IOException e) {
// // TODO Auto-generated catch block
// e.printStackTrace();
// }
