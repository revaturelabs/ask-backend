...
public class AskApplicationControllerTests {
	...
	public void testQuestionHashCodeAndEquals() {
		...
		assertTrue(exampleQuesiton.equals(exampleQuastion2) && exampleQuastion2.equals(exampleQuesiton));
...
//		exampleQuesiton13.addImageToImages(null);
		...
		assertFalse(exampleQuesiton.equals(exampleQuastion2) & exampleQuastion2.equals(exampleQuesiton));
//		assertTrue(exampleQuestion3.equals(exampleQuastion2) & exampleQuastion2.equals(exampleQuestion3));
		assertFalse(exampleQuesiton.equals(exampleQuesiton4) & exampleQuesiton4.equals(exampleQuesiton));
		assertFalse(exampleQuesiton.equals(exampleQuesiton5) & exampleQuesiton5.equals(exampleQuesiton));
		assertFalse(exampleQuesiton.equals(exampleQuesiton6) & exampleQuesiton6.equals(exampleQuesiton));
		assertFalse(exampleQuesiton.equals(exampleQuesiton7) & exampleQuesiton7.equals(exampleQuesiton));
		assertFalse(exampleQuesiton.equals(exampleQuesiton8) & exampleQuesiton8.equals(exampleQuesiton));
//		assertFalse(exampleQuesiton.equals(exampleQuesiton9) & exampleQuesiton9.equals(exampleQuesiton));
		assertFalse(exampleQuesiton.equals(exampleQuesiton10) & exampleQuesiton10.equals(exampleQuesiton));
		assertFalse(exampleQuesiton.equals(exampleQuesiton11) & exampleQuesiton11.equals(exampleQuesiton));
		assertFalse(exampleQuesiton.equals(exampleQuesiton12) & exampleQuesiton12.equals(exampleQuesiton));
//		assertFalse(exampleQuesiton.equals(exampleQuesiton13) & exampleQuesiton13.equals(exampleQuesiton));
		assertFalse(exampleQuesiton.equals(exampleQuesiton14) & exampleQuesiton14.equals(exampleQuesiton));
		assertFalse(exampleQuesiton.equals(user));
		
		assertFalse(exampleQuesiton.hashCode() == exampleQuastion2.hashCode());
		
		assertTrue(exampleQuesiton.getAssociatedTags() != null & exampleQuastion2.getAssociatedTags() !=  null);
		assertTrue(exampleQuesiton.getBody() != null & exampleQuastion2.getBody() == null);
		assertTrue(exampleQuesiton.getHead() == exampleQuesiton4.getHead() & exampleQuesiton.getHead() != null);
		assertTrue(exampleQuesiton.getHighlightedResponseId() == 1 & exampleQuastion2.getHighlightedResponseId() == null);
		...
		assertTrue(exampleQuesiton.getCreationDate() != exampleQuastion2.getCreationDate() & exampleQuastion2.getCreationDate() == null);
	...
	public void testGetImages() {
		...
		assertEquals(ResponseEntity.ok(questionServiceMock.getById(1).getImages()), questionControllerImpl.getImages(1));
	}
	...
	public void testFilterByTagsForTagNotFoundException() {
		...
		assertEquals(ResponseEntity.ok(null),
				questionControllerImpl.filterByTags(0, 20, true, null));
	}
