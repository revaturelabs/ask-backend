...
// */
// @Test
// public void testAddImageToQuestion() throws QuestionNotFoundException, ImageConflictException,
// IOException {
// when(questionRepositoryMock.findById(1)).thenReturn(Optional.of(testQuestion1));
...
//
// when(questionRepositoryMock.findById(1)).thenReturn(Optional.of(testQuestion1));
// when(imageServiceMock.addImage(testQuestion1,
...
// .thenReturn(page1);
// when(questionRepositoryMock.findAllContainingAtLeastOneTag(expertTags,
// pageable)).thenReturn(page2);
// assertNotNull(questionRepositoryMock.findAllContainingAllTags(expertTags, expertTags.size(),
// pageable));
// assertEquals(questionRepositoryMock.findAllContainingAllTags(expertTags, expertTags.size(),
// pageable), page1);
//
