...
public class TagServiceTest {
  ...
  public void tagCreationAccuracyTest() {
    when(tagRepositoryMock.save(ServiceMockData.testTag1))
        .thenReturn(ServiceMockData.testTag1PostCreate);

    assertEquals(ServiceMockData.testTag1PostCreate,
        tagServiceImpl.create(ServiceMockData.testTag1));
  }
  ...
  public void tagUpdateTest() {
    ...
    when(tagRepositoryMock.findById(testTag1UpdateInfo.getId()))
        .thenReturn(Optional.of(ServiceMockData.testTag1));
  ...
  public void createOrUpdateTagTest() {
    ...
    tagReturnList.addAll(Arrays.asList(ServiceMockData.testTag1, ServiceMockData.testTag2,
        ServiceMockData.testTag3, nonExistentTag));
