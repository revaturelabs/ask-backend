...
public class ResponseServiceTest {
  ...
  public void responseCreationAccuracyTest() {
    when(responseRepositoryMock.save(ServiceMockData.testResponse1))
        .thenReturn(ServiceMockData.testResponse1PostCreate);

    assertEquals(ServiceMockData.testResponse1PostCreate,
        responseServiceImpl.create(ServiceMockData.testResponse1));
  }
  ...
  public void responseUpdateTest() {
    ...
    when(responseRepositoryMock.findById(1)).thenReturn(Optional.of(ServiceMockData.testResponse1));
    when(responseRepositoryMock.save(testResponse1UpdateInfo))
        .thenReturn(ServiceMockData.testResponse1);

    assertEquals(ServiceMockData.testResponse1,
        responseServiceImpl.update(testResponse1UpdateInfo));
  }
